...
public class BannerUtil {
    ...
    static {
        ...
        BANNER_OVERRIDES.put("org.cyanogenmod.appdrawer", R.drawable.banner_apps);
        BANNER_OVERRIDES.put("com.smartup.tv", R.drawable.banner_tv);
        BANNER_OVERRIDES.put("com.phlox.tvwebbrowser", R.drawable.banner_silk);
    }
}

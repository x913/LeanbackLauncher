...
public class SettingsAdapter extends AppsAdapter {
    ...
    private LaunchPoint setNetwork(Resources res, LaunchPoint launchPoint) {
        ...
        Log.d("SetEthernetStatusAdapter", String.valueOf(connectivityStatus.mNetworkType));
        switch (connectivityStatus.mNetworkType) {
            case 1:
                ...
                launchPoint.setIconDrawable(getNetResourceDrawable(launchPoint, "ic_settings_ethernet_no_cable"));
                break;
            case 3:
            case 5:
            ...
            case 7:
                ...
                launchPoint.setIconDrawable(getNetResourceDrawable(launchPoint, "ic_settings_ethernet_active"));
                titleId = R.string.settings_network;
                break;
            case 9:
                title = connectivityStatus.mWifiSsid;
            ...
            case 11:
                ...
                launchPoint.setIconDrawable(getNetResourceDrawable(launchPoint, "ic_settings_ethernet_no_internet"));
                break;
            case 13:
